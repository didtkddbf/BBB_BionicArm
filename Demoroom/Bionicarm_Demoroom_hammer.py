...
class MyWindow(QMainWindow, form_class):
    ...
    def Loop(self):
        ...
        #-----------Object Angle-----------------
            ...
            if count<10:                         # Start point
                obj_Ang = org_Ang

            elif count >= 10 and count < 20:    # 20deg to 45deg
                obj_Ang = (org_Ang + 60*C2A)
        ...
        #----------Error Calculation-----------
            ...
            RealAngle = (cur_Ang - org_Ang)/23
            Realobject = (obj_Ang - org_Ang)/23
            SMAcompensation = -0.0097*Realobject*Realobject + 3.706*Realobject + 110
            ...
            elif count >= 10 and count < 10.5:
                PWM_1 = 1023
                Fan_1 = 1023
                Fan_2 = 0
            elif count >= 10.5 and count < 11:
                PWM_1 = 0
                Fan_1 = 1023
                Fan_2 = 0
            elif count >= 11 and count < 11.5:
                PWM_1 = 1023
                Fan_1 = 1023
                Fan_2 = 0
            elif count >= 11.5 and count < 12:
                PWM_1 = 0
                Fan_1 = 1023
                Fan_2 = 0

            elif count >= 12 and count < 12.5:
                PWM_1 = 1023
                Fan_1 = 1023
                Fan_2 = 0

            elif count >= 12.5 and count < 13:
                PWM_1 = 0
                Fan_1 = 1023
                Fan_2 = 0

            elif count >= 13 and count < 13.5:
                PWM_1 = 1023
                Fan_1 = 1023
                Fan_2 = 0
            elif count >= 13.5 and count < 14:
                PWM_1 = 0
                Fan_1 = 1023
                Fan_2 = 0

            elif count >= 14 and count < 14.5:
                PWM_1 = 1023
                Fan_1 = 1023
                Fan_2 = 0
            elif count >= 14.5 and count < 15:
                PWM_1 = 0
                Fan_1 = 1023
                Fan_2 = 0
            elif count >= 15 and count < 15.5:
                PWM_1 = 1023
                Fan_1 = 1023
                Fan_2 = 0

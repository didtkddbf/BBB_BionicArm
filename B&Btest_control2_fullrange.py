...
class MyWindow(QMainWindow, form_class):
    ...
    def Cooling(self):
        ...
        while Stop_push != True:
            ...
            R_angle = int((can_bus.displacement - 4096)/22.7)
    ...
    def Loop(self):
        ...
        #-----------Object Angle-----------------
            ...
            if cur_time < 100:                         # Start point
                PWM_1 = 120
                Fan_1 = 600

            elif cur_time < 120:                         # Start point
                PWM_1 = 0
        ...
        #             PWM_2 = 1023
            ...
            # Force_t = can_bus.force
            # self.Force_2.display(Force_t)
            self.ADC_2.display(Fan_1)
            self.Temp_2.display(Temp_t)

            print('{0} {1} {2} {3} {4} {5} {6} {7}'.format((time.time()-start_time), cur_Ang, obj_Ang, Force_b, Temp_b, Temp_t, PWM_1, Fan_1))
            #------------Previous DATA---------------
            error_prev = error
            time_prev = time.time()
            count = count + 0.1
